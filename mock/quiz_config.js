...
questions[0] = "<h2>1) JavaScript is</h2>";
choices[0] = new Array();
...
questions[1] = "<h2>2) JavaScript is</h2>";
choices[1] = new Array();
...
questions[2] = "<h2>3) To comment out a line in JavaScript</h2>";
choices[2] = new Array();
...
questions[3] = "<h2>4) JavaScript can only run on Windows</h2>";
choices[3] = new Array();
choices[3][0] = "True";
choices[3][1] = "False";
answers[3] = choices[3][1];

questions[4] = "<h2>5) Semicolons are optional at the end of a JavaScript statement.</h2>";
choices[4] = new Array();
choices[4][0] = "True";
choices[4][1] = "False";
answers[4] = choices[4][0];

questions[5] = "<h2>6) The four basic data types are:</h2>";
choices[5] = new Array();
