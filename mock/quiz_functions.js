...
function showResult(questionId) {
  if(answers[questionId] == useranswers[questionId]) {
    document.getElementById('result_' + questionId).innerHTML = '<font color="green">Correct</font>';
  } else {
    document.getElementById('result_' + questionId).innerHTML = '<font color="red">Wrong</font>';
  }
}
function showScore() {
